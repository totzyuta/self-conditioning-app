...
export default function StepsRecordScreen({ onClose, onSubmit, v2, initialDate, editDate }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const n = steps.trim() === "" ? null : Number(steps);
    onSubmit({
      date,
      steps: Number.isFinite(n) ? Math.trunc(n) : null,
      stepsNote: note,
    });
    setSaved(true);
